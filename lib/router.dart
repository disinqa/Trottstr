...
import 'package:trottstr/screens/country_tax_limits_management_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/country-tax-limits',
        builder: (context, state) => const CountryTaxLimitsManagementScreen(),
      ),
    ],
  );
});
